#undef SNOWROLLERV2_API
#undef SNOWROLLERV2_VTABLE
...
#define UE_PROJECT_NAME SnowRollerV2
...
#define SNOWROLLERV2_VTABLE DLLEXPORT_VTABLE
#define SNOWROLLERV2_API DLLEXPORT
